...
function initializeIpcHandlers(deps) {
  ...
  require$$1.ipcMain.handle("set-initial-credits", async (_event, credits) => {
    ...
    try {
      ...
      console.error("Error setting initial credits:", error2);
      throw error2;
    }
  });
  require$$1.ipcMain.handle("decrement-credits", async () => {
    const mainWindow = deps.getMainWindow();
    if (!mainWindow) return;
    try {
      ...
      console.error("Error decrementing credits:", error2);
    }
  });
  require$$1.ipcMain.handle("get-screenshot-queue", () => {
    return deps.getScreenshotQueue();
  });
  require$$1.ipcMain.handle("get-extra-screenshot-queue", () => {
    return deps.getExtraScreenshotQueue();
  });
  require$$1.ipcMain.handle("delete-screenshot", async (event, path2) => {
    return deps.deleteScreenshot(path2);
  });
  require$$1.ipcMain.handle("get-image-preview", async (event, path2) => {
    return deps.getImagePreview(path2);
  });
  require$$1.ipcMain.handle("process-screenshots", async () => {
    var _a;
  ...
  require$$1.ipcMain.handle("get-screenshots", async () => {
    try {
      let previews = [];
  ...
  require$$1.ipcMain.handle("trigger-screenshot", async () => {
    const mainWindow = deps.getMainWindow();
    if (mainWindow) {
      try {
  ...
  require$$1.ipcMain.handle("take-screenshot", async () => {
    try {
      const screenshotPath = await deps.takeScreenshot();
      const preview = await deps.getImagePreview(screenshotPath);
  ...
  require$$1.ipcMain.handle("get-pkce-verifier", () => {
    return require$$0$1.randomBytes(32).toString("base64url");
  });
  require$$1.ipcMain.handle("open-external-url", (event, url2) => {
    require$$1.shell.openExternal(url2);
  });
  require$$1.ipcMain.handle("open-settings-portal", () => {
    require$$1.shell.openExternal("https://www.interviewcoder.co/settings");
  });
  require$$1.ipcMain.handle("open-subscription-portal", async (_event, authData) => {
    try {
      const url2 = "https://www.interviewcoder.co/checkout";
      await require$$1.shell.openExternal(url2);
      return { success: true };
    } catch (error2) {
      console.error("Error opening checkout page:", error2);
      return {
        success: false,
        error: error2 instanceof Error ? error2.message : "Failed to open checkout page"
      };
    }
  });
  require$$1.ipcMain.handle("toggle-window", () => {
    try {
  ...
  require$$1.ipcMain.handle("reset-queues", async () => {
    try {
      deps.clearQueues();
      return { success: true };
    } catch (error2) {
  ...
  require$$1.ipcMain.handle("trigger-process-screenshots", async () => {
    var _a;
    try {
      await ((_a = deps.processingHelper) == null ? void 0 : _a.processScreenshots());
      return { success: true };
  ...
  require$$1.ipcMain.handle("trigger-reset", () => {
    var _a;
    try {
  ...
  require$$1.ipcMain.handle("trigger-move-left", () => {
    try {
      deps.moveWindowLeft();
      return { success: true };
    } catch (error2) {
  ...
  require$$1.ipcMain.handle("trigger-move-right", () => {
    try {
  ...
  require$$1.ipcMain.handle("trigger-move-up", () => {
    try {
      deps.moveWindowUp();
      return { success: true };
    } catch (error2) {
  ...
  require$$1.ipcMain.handle("trigger-move-down", () => {
    try {
      deps.moveWindowDown();
      return { success: true };
    } catch (error2) {
...
const generateString = (size = 16, alphabet = ALPHABET.ALPHA_DIGIT) => {
  ...
  require$$0$1.randomFillSync(randomValues);
...
const API_BASE_URL = isDev$1 ? "http://localhost:3000" : "https://www.interviewcoder.co";
class ProcessingHelper {
  ...
  async getCredits() {
    ...
    try {
      ...
      if (typeof credits !== "number" || credits === void 0 || credits === null) {
    ...
    if (view === "queue") {
      ...
      try {
        ...
        const screenshots = await Promise.all(
          screenshotQueue.map(async (path2) => ({
            path: path2,
        ...
        if (!result.success) {
          ...
          if ((_a = result.error) == null ? void 0 : _a.includes("API Key out of credits")) {
            mainWindow.webContents.send(
              this.deps.PROCESSING_EVENTS.OUT_OF_CREDITS
            );
          } else if ((_b = result.error) == null ? void 0 : _b.includes("OpenAI API key not found")) {
            mainWindow.webContents.send(
        ...
        if (axios.isCancel(error2)) {
          ...
          mainWindow.webContents.send(
            this.deps.PROCESSING_EVENTS.INITIAL_SOLUTION_ERROR,
            error2.message || "Server error. Please try again."
          );
        }
        console.log("Resetting view to queue due to error");
        this.deps.setView("queue");
      ...
      try {
        ...
        try {
          ...
          console.error("API Error Details:", {
            ...
            data: (_b = error2.response) == null ? void 0 : _b.data,
            message: error2.message,
            code: error2.code
          });
          if (((_d = (_c = error2.response) == null ? void 0 : _c.data) == null ? void 0 : _d.error) && typeof error2.response.data.error === "string") {
            if (error2.response.data.error.includes("Operation timed out")) {
              throw new Error(
                "Operation timed out after 1 minute. Please try again."
              );
            }
            if (error2.response.data.error.includes("API Key out of credits")) {
              throw new Error(error2.response.data.error);
            }
            throw new Error(error2.response.data.error);
          }
          throw new Error(error2.message || "Server error. Please try again.");
        }
      } catch (error2) {
        console.error("Processing error details:", {
          message: error2.message,
          code: error2.code,
          response: (_e = error2.response) == null ? void 0 : _e.data,
          retryCount
        });
        if (axios.isCancel(error2) || retryCount >= MAX_RETRIES) {
  ...
  async generateSolutionsHelper(signal) {
    ...
    try {
      ...
      const mainWindow = this.deps.getMainWindow();
      if (error2.code === "ECONNABORTED" || ((_a = error2.response) == null ? void 0 : _a.status) === 504) {
      ...
      if ((_d = (_c = (_b = error2.response) == null ? void 0 : _b.data) == null ? void 0 : _c.error) == null ? void 0 : _d.includes("API Key out of credits")) {
        if (mainWindow) {
          mainWindow.webContents.send(
            this.deps.PROCESSING_EVENTS.OUT_OF_CREDITS
          );
        }
        return { success: false, error: error2.response.data.error };
      }
      if ((_g = (_f = (_e = error2.response) == null ? void 0 : _e.data) == null ? void 0 : _f.error) == null ? void 0 : _g.includes(
  ...
  async processExtraScreenshotsHelper(screenshots, signal) {
    ...
    try {
      ...
      if ((_c = (_b = (_a = error2.response) == null ? void 0 : _a.data) == null ? void 0 : _b.error) == null ? void 0 : _c.includes("Operation timed out")) {
        this.cancelOngoingRequests();
        this.deps.clearQueues();
        this.deps.setView("queue");
        if (mainWindow && !mainWindow.isDestroyed()) {
      ...
      if ((_f = (_e = (_d = error2.response) == null ? void 0 : _d.data) == null ? void 0 : _e.error) == null ? void 0 : _f.includes("API Key out of credits")) {
        if (mainWindow) {
          mainWindow.webContents.send(
            this.deps.PROCESSING_EVENTS.OUT_OF_CREDITS
          );
      ...
      if ((_i = (_h = (_g = error2.response) == null ? void 0 : _g.data) == null ? void 0 : _h.error) == null ? void 0 : _i.includes(
        "Please close this window and re-enter a valid Open AI API key."
      )) {
        if (mainWindow) {
          mainWindow.webContents.send(
...
function rng() {
  if (poolPtr > rnds8Pool.length - 16) {
    require$$0$1.randomFillSync(rnds8Pool);
    poolPtr = 0;
  }
  return rnds8Pool.slice(poolPtr, poolPtr += 16);
}
const native = { randomUUID: require$$0$1.randomUUID };
...
const execFileAsync = require$$1$1.promisify(require$$1$5.execFile);
class ScreenshotHelper {
  constructor(view = "queue") {
    ...
    this.view = "queue";
    this.view = view;
    this.screenshotDir = path$k.join(require$$1.app.getPath("userData"), "screenshots");
  ...
  async captureScreenshotMac() {
    const tmpPath = path$k.join(require$$1.app.getPath("temp"), `${v4()}.png`);
...
class ShortcutsHelper {
  ...
  registerGlobalShortcuts() {
    require$$1.globalShortcut.register("CommandOrControl+H", async () => {
      const mainWindow = this.deps.getMainWindow();
      if (mainWindow) {
    ...
    require$$1.globalShortcut.register("CommandOrControl+Enter", async () => {
      var _a;
      await ((_a = this.deps.processingHelper) == null ? void 0 : _a.processScreenshots());
    });
    require$$1.globalShortcut.register("CommandOrControl+R", () => {
      var _a;
      console.log(
    ...
    require$$1.globalShortcut.register("CommandOrControl+Left", () => {
      console.log("Command/Ctrl + Left pressed. Moving window left.");
      this.deps.moveWindowLeft();
    });
    require$$1.globalShortcut.register("CommandOrControl+Right", () => {
      console.log("Command/Ctrl + Right pressed. Moving window right.");
      this.deps.moveWindowRight();
    });
    require$$1.globalShortcut.register("CommandOrControl+Down", () => {
      console.log("Command/Ctrl + down pressed. Moving window down.");
      this.deps.moveWindowDown();
    });
    require$$1.globalShortcut.register("CommandOrControl+Up", () => {
      console.log("Command/Ctrl + Up pressed. Moving window Up.");
      this.deps.moveWindowUp();
    });
    require$$1.globalShortcut.register("CommandOrControl+B", () => {
...
function requireAppUpdater() {
  ...
  const builder_util_runtime_12 = out;
  const crypto_12 = require$$0$1;
  const os_12 = require$$1$4;
    ...
    doInstall(options) {
      ...
      this.spawnLog(options.installerPath, args).catch((e) => {
        ...
        if (errorCode === "UNKNOWN" || errorCode === "EACCES") {
          ...
          require$$1.shell.openPath(options.installerPath).catch((err) => this.dispatchError(err));
        } else {
          this.dispatchError(e);
        }
      });
...
function initAutoUpdater() {
  ...
  require$$1.ipcMain.handle("start-update", async () => {
...
if (process.platform === "darwin") {
  require$$1.app.setAsDefaultProtocolClient("interview-coder");
} else {
  require$$1.app.setAsDefaultProtocolClient("interview-coder", process.execPath, [
    require$$1$2.resolve(process.argv[1] || "")
  ]);
}
...
async function createWindow() {
  ...
  const windowSettings = {
    ...
    webPreferences: {
      ...
      preload: isDev ? require$$1$2.join(__dirname, "../dist-electron/preload.js") : require$$1$2.join(__dirname, "preload.js"),
      scrollBounce: true
    },
    show: true,
    frame: false,
  ...
  state.mainWindow = new require$$1.BrowserWindow(windowSettings);
  ...
  if (isDev) {
    ...
    console.log(
      ...
      require$$1$2.join(__dirname, "../dist/index.html")
    );
    state.mainWindow.loadFile(require$$1$2.join(__dirname, "../dist/index.html"));
  }
...
function loadEnvVariables() {
  if (isDev) {
    console.log("Loading env variables from:", require$$1$2.join(process.cwd(), ".env"));
    config_1({ path: require$$1$2.join(process.cwd(), ".env") });
  } else {
    console.log(
      "Loading env variables from:",
      require$$1$2.join(process.resourcesPath, ".env")
    );
    config_1({ path: require$$1$2.join(process.resourcesPath, ".env") });
  }
...
require$$1.app.on("open-url", (event, url2) => {
...
require$$1.app.whenReady().then(initializeApp);
